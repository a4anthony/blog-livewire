...
foreach ($files as $file) {
    ...
    match (true) {
        str_contains($file, determineSeparator('src/BlogLivewire.php')) => rename($file, determineSeparator('./src/'.$className.'.php')),
        str_contains($file, determineSeparator('src/BlogLivewireServiceProvider.php')) => rename($file, determineSeparator('./src/'.$className.'ServiceProvider.php')),
        str_contains($file, determineSeparator('src/Facades/BlogLivewire.php')) => rename($file, determineSeparator('./src/Facades/'.$className.'.php')),
        str_contains($file, determineSeparator('src/Commands/BlogLivewireCommand.php')) => rename($file, determineSeparator('./src/Commands/'.$className.'Command.php')),
        ...
        str_contains($file, determineSeparator('config/blog-livewire.php')) => rename($file, determineSeparator('./config/'.$packageSlugWithoutPrefix.'.php')),
