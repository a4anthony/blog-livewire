...
return [
    ...
    'admin_blog_index_route' => 'admin.blog',
    ...
    'single_post_ad' => [
        ...
        'sub_header' => 'Book a session with one of our expert tutors and get a free practice quiz. Click the button below to get started.',
